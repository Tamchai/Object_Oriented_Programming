...
class Subject:
    ...
    def assign_teacher(self):
        return self.__assign_teacher
    @assign_teacher.setter
    def assign_teacher(self,new):
        self.__assign_teacher=new
    @property
...
def list_student_enrolled_in_subject(subject_id):
    ...
    for enrollment in filter_student_list:    
        student_dict[enrollment.student_id] = enrollment.student_name
    return student_dict
...
print([i.subject_id for i in lst])
print("")
